...
const inMemoryBackend = createInMemoryKVStorageBackend((k, v) => {})
const indexedDBBackend = createIndexedDB_KVStorageBackend('mask-plugin', () => {})

const inMemoryStorage = createKVStorageHost(inMemoryBackend, {
    on() {
        return noop
    },
})
const indexedDBStorage = createKVStorageHost(indexedDBBackend, {
    on() {
        return noop
    },
})
