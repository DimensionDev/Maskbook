...
if (typeof SharedWorker === 'function') {
    const worker = new SharedWorker(new URL('../../plugin-worker/index.ts', import.meta.url).href)
    ...
    const worker = new Worker(new URL('../../plugin-worker/index.ts', import.meta.url).href)
