...
export const ImportCreateWallet = memo<Props>(
    PrivyEnvGuard(function ImportCreateWallet({ onChoose, ...props }) {
        ...
        return (
            <Box display="flex" flexDirection="column" gap={1.5} position="relative" {...props}>
                ...
                <Box
                    className={classes.addWalletWrapper}
                    onClick={() => handleChoose(DashboardRoutes.RecoveryMaskWallet)}>
                    <div
