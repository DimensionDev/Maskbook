...
import type { WalletConnectedOrigin } from './types.js'

// Note: Wallet was a plugin in the past, but now it's a core service in Mask.
export const walletDatabase = createPluginDatabase<WalletRecord | SecretRecord | LockerRecord | WalletConnectedOrigin>(
    PluginID.Wallet,
)
