...
export default {
    ...
    "mask/content-script/site-adaptors/twitter.com/locales/%locale%.json":
        "DO_NOT_USE",
    ...
    "plugins/ScamSniffer/src/locales/%locale%.json":
    ...
    "plugins/GoPlusSecurity/src/locales/%locale%.json":
        "io.gopluslabs.security",
    "plugins/CrossChainBridge/src/locales/%locale%.json":
    ...
    "plugins/Collectible/src/locales/%locale%.json":
    ...
    "plugins/ProfileCard/src/locales/%locale%.json":
