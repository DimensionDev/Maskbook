...
const svg = (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 276 276">
        <g>
            <path fill="#8dc63f" d="M276,137.39A138,138,0,1,1,137.39,0h0A138,138,0,0,1,276,137.39Z" />
            <path
                fill="#f9e988"
            ...
            />
            <path fill="#fff" d="M213.64,131.2a5.35,5.35,0,1,1-5.38-5.32A5.36,5.36,0,0,1,213.64,131.2Z" />
            <path fill="#009345" d="M138.48,69.91c6.43.46,29.68,8,35.68,12.12-5-14.5-21.83-16.43-35.68-12.12Z" />
            <path fill="#fff" d="M144.6,106.58a24.68,24.68,0,1,1-24.69-24.67h0a24.68,24.68,0,0,1,24.68,24.66Z" />
...
export function CoinGeckoIcon(props: SvgIconProps) {
