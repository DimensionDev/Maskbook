    ...
    <SvgIcon
        ...
        <defs>
            <radialGradient
                ...
                r="49.7661178%"
                id="radialGradient-1">
                <stop stopColor="#1D1E27" offset="0%" />
                <stop stopColor="#1F202A" offset="22.0032839%" />
                <stop stopColor="#20222E" offset="75.9230432%" />
                <stop stopColor="#191A21" offset="100%" />
            </radialGradient>
        </defs>
        <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
            <g id="COMBO_token" transform="translate(1.000000, 1.000000)" fillRule="nonzero">
                <path
