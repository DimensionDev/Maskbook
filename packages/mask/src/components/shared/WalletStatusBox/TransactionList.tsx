...
import { getContractOwnerDomain, TransactionStateType } from '@masknet/web3-shared-evm'
...
interface Props extends ListProps {
    transactions: RecentTransaction<Web3Helper.ChainIdAll, Web3Helper.TransactionAll>[]
    onClear?(tx: RecentTransaction<Web3Helper.ChainIdAll, Web3Helper.TransactionAll>): void
}
