...
export const AccountAvatar = memo<AccountAvatar>(({ avatar, network, isValid }) => {
    ...
    return (
        <div className={classes.container}>
            {avatar ? <Avatar className={classes.avatar} src={avatar} /> : <GrayMasks className={classes.avatar} />}
            {network ? <div className={classes.network}>{SOCIAL_MEDIA_ICON_MAPPING[network]}</div> : null}
