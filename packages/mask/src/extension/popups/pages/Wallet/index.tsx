...
const ImportWallet = lazy(() => import(/* webpackPrefetch: true */ './ImportWallet'))
const AddDeriveWallet = lazy(() => import(/* webpackPrefetch: true */ './AddDeriveWallet'))
const WalletSettings = lazy(() => import(/* webpackPrefetch: true */ './WalletSettings'))
const WalletRename = lazy(() => import(/* webpackPrefetch: true */ './WalletRename'))
const DeleteWallet = lazy(() => import(/* webpackPrefetch: true */ './DeleteWallet'))
const CreateWallet = lazy(() => import(/* webpackPrefetch: true */ './CreateWallet'))
const SwitchWallet = lazy(() => import(/* webpackPrefetch: true */ './SwitchWallet'))
const BackupWallet = lazy(() => import(/* webpackPrefetch: true */ './BackupWallet'))
const AddToken = lazy(() => import(/* webpackPrefetch: true */ './AddToken'))
...
const Unlock = lazy(() => import(/* webpackPrefetch: true */ './Unlock'))
const SetPaymentPassword = lazy(() => import(/* webpackPrefetch: true */ './SetPaymentPassword'))
const WalletRecovery = lazy(() => import(/* webpackPrefetch: true */ './WalletRecovery'))
const LegacyWalletRecovery = lazy(() => import(/* webpackPrefetch: true */ './LegacyWalletRecovery'))
const ReplaceTransaction = lazy(() => import(/* webpackPrefetch: true */ './ReplaceTransaction'))
