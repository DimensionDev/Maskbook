...
export const postEditorContentInPopupSelector: () => LiveSelector<E, true> = () => querySelector<E>('[role="main"]')
export const postEditorInPopupSelector: () => LiveSelector<E, true> = () =>
    querySelector<E>('[role="main"] div[data-testid="toolBar"] div[data-testid="geoButton"]')
