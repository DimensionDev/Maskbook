...
import { SetOfferForm } from './SetOfferForm'
...
export function TraderxyzDialog({ open, onClose }: TraderDialogProps) {
    const { t } = useI18N()
    ...
    const [openFromRemote, setValue] = useState('')
        ...
        <TargetChainIdContext.Provider>
            <AllProviderTradeContext.Provider>
                <InjectedDialog
                    ...
                    title={t('plugin_traderxyz_title')}>
