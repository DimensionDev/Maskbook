...
import { R2D2TokenList } from '@masknet/web3-providers'
...
export const fetchERC20TokensFromTokenListsMap = async (chainId: ChainId) => {
    ...
    const ERC20Tokens = await R2D2TokenList.getFungibleTokenList(chainId, [...FUNGIBLE_TOKEN_LISTS, TOKEN_LIST_URL])
