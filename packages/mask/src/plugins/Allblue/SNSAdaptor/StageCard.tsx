                    ...
                    <Grid item sm={6} xs={12}>
                        <Box sx={{ padding: '0 24px' }}>
                            ...
                            {userStoryStatus.puzzles.waiting === 1 && (
                                ...
                                } ${t('plugin_allblue_puzzle_to_be_revealed')}`}</Typography>
                            )}
                            {userStoryStatus.puzzles.waiting > 1 && (
                                <Typography variant={'body2'} color={'text.secondary'} gutterBottom={true}>{`${
                                    userStoryStatus.puzzles.waiting
                                } ${t('plugin_allblue_puzzles_to_be_revealed')}`}</Typography>
                            )}
                        </Box>
                    </Grid>
                    <Grid item sm={6} xs={12}>
                        <Box sx={{ padding: '0 24px' }}>
                            ...
                            {userStoryStatus.polls.waiting === 1 && (
                                ...
                                } ${t('plugin_allblue_poll_to_be_revealed')}`}</Typography>
                            )}
                            {userStoryStatus.polls.waiting > 1 && (
                                <Typography variant={'body2'} color={'text.secondary'} gutterBottom={true}>{`${
                                    userStoryStatus.polls.waiting
                                } ${t('plugin_allblue_polls_to_be_revealed')}`}</Typography>
                            )}
                        </Box>
                    </Grid>
                </Grid>
