...
export const LDO_PAIRS: [FungibleToken<ChainId, SchemaType>, FungibleToken<ChainId, SchemaType>][] = [
    [
...
export const AAVE_PAIRS: [FungibleToken<ChainId, SchemaType>, FungibleToken<ChainId, SchemaType>][] = [
    [
