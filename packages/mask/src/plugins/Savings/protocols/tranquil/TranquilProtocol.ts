...
import { ChainId, getTranquilConstants, ZERO_ADDRESS, createContract } from '@masknet/web3-shared-evm'
import { ProtocolType, PairToken, TokenDetail } from '../../types'
...
export default class TranquilProtocol extends BenQiRewardProtocol {
    ...
    constructor(pair: PairToken, allPairs: PairToken[], rewardTokens: RewardToken[], config: PairConfig) {
