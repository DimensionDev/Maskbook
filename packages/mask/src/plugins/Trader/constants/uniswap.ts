import { ChainId, AMPL, DAI, USDC, USDT, WBTC, MAGIC, WNATIVE, WNATIVE_ONLY } from '@masknet/web3-shared-evm'
...
export const UNISWAP_BASE_AGAINST_TOKENS: ERC20AgainstToken = {
    ...WNATIVE_ONLY,
    [ChainId.Mainnet]: [WNATIVE, DAI, USDC, USDT, WBTC, MAGIC].map((x) => x[ChainId.Mainnet]),
