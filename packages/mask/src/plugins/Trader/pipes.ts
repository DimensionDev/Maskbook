...
export const resolveTradeProviderName = createLookupTableResolver<TradeProvider, string>(
    {
        ...
        [TradeProvider.SPIRITSWAP]: 'SpiritSwap',
        [TradeProvider.SPOOKYSWAP]: 'SpookySwap',
    },
    (tradeProvider) => {
...
export function resolveTradeProviderLink(tradeProvider: TradeProvider, networkType: NetworkType) {
    switch (tradeProvider) {
        ...
        case TradeProvider.SPIRITSWAP:
            return 'https://app.spiritswap.finance/#/'
        default:
...
export function resolveTradePairLink(tradeProvider: TradeProvider, address: string, networkType: NetworkType) {
    switch (tradeProvider) {
        ...
        case TradeProvider.WANNASWAP:
            ...
            return ''
        case TradeProvider.SPOOKYSWAP:
            return `https://info.spookyswap.finance/pair/${address}`
        case TradeProvider.SPIRITSWAP:
            return `https://info.spiritswap.finance/pair/${address}`
        default:
            unreachable(tradeProvider)
    }
}
...
export const resolveZrxTradePoolName = createLookupTableResolver<ZrxTradePool, string>(
    {
        ...
        [ZrxTradePool.SpiritSwap]: 'SpiritSwap',
        [ZrxTradePool.SpookySwap]: 'SpookySwap',
    },
    'Unknown',
)
