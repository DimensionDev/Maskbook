...
import { SwapColorful as SwapColorfulIcon } from '@masknet/icons'
...
> = {
    ...
    ApplicationEntries: [
        (() => {
            const icon = <SwapColorfulIcon size={36} />
    ...
    wrapperProps: {
        icon: <SwapColorfulIcon size={24} sx={{ filter: 'drop-shadow(0px 6px 12px rgba(254, 156, 0, 0.2))' }} />,
        backgroundGradient:
