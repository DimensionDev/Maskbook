...
import { SchemaType, FungibleTokenDetailed } from '@masknet/web3-shared-evm'
...
export function useTradeComputed(
    ...
    return useMemo((): TradeComputed<NativeTokenWrapper> | null => {
        ...
        return {
            ...
            trade_: {
                isWrap:
                    (strategy === TradeStrategy.ExactIn && inputToken?.type === SchemaType.Native) ||
                    (strategy === TradeStrategy.ExactOut && outputToken?.type === SchemaType.Native),
