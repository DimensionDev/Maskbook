...
import { createERC20Token, FungibleTokenDetailed } from '@masknet/web3-shared-evm'
import { Web3TokenType, ZERO } from '@masknet/web3-shared-base'
...
export function useTradeApproveComputed(
    ...
    return useMemo(() => {
        return {
            approveToken:
                token?.type === Web3TokenType.ERC20
