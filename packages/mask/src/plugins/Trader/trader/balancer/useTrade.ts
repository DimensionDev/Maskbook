import { FungibleTokenDetailed, isZeroAddress, useBlockNumber, useTokenConstants } from '@masknet/web3-shared-evm'
...
export function useTrade(
    ...
    return useAsyncRetry(async () => {
        ...
        const sellToken = isZeroAddress(inputToken.address) ? WNATIVE_ADDRESS : inputToken.address
        const buyToken = isZeroAddress(outputToken.address) ? WNATIVE_ADDRESS : outputToken.address
