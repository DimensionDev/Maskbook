...
import { useChainContext, useWeb3State, useWeb3Connection } from '@masknet/web3-hooks-base'
...
export function useAvailability(
    ...
    return useAsyncRetry(async () => {
        if (!id || !contractAddress || !connection || !Others?.chainResolver.isValid(chainId)) return null
