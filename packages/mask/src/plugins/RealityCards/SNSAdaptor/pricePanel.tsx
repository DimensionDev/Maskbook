...
import { FormattedBalance, SelectTokenChip, SelectTokenChipProps, useStylesExtends } from '@masknet/shared'
...
export interface PricePanelProps extends withClasses<'root'> {
    amount: string
    maxAmount?: string
    minAmount?: string
