...
import { NetworkPluginID, formatBalance, calcBalance } from '@masknet/web3-shared-base'
...
export function CheckoutDialog(props: CheckoutDialogProps) {
    ...
    const validationMessage = useMemo(() => {
        ...
        if (new BigNumber(asset?.value?.priceInEth).gt(calcBalance(balance.value, token?.value?.decimals))) {
