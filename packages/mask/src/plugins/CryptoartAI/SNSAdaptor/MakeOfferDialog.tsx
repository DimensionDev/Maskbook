...
import { FungibleTokenDetailed, useFungibleTokenWatched, useChainId } from '@masknet/web3-shared-evm'
                ...
                <Card elevation={0}>
                    <CardContent>
                        ...
                        <SelectTokenAmountPanel
                            ...
                            disableNativeToken={!paymentTokens.some((x: any) => isNativeTokenAddress(x.address))}
