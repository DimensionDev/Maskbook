...
import Guide from '../Tips/TipsDialog/Guide.js'
import { TipsButton } from './TipsButton/index.js'
...
export const RealmContent: Plugin.InjectUI<Plugin.SNSAdaptor.TipsRealmOptions> = ({ identity, slot, recipients }) => {
        ...
        return (
            <Guide>
                <Stack display="inline-block" width="38px" height="38px" position="relative" top={2}>
                    <TipsButton className={buttonClassMap[slot]} receiver={identity} addresses={recipients} />
                </Stack>
            </Guide>
        )
    }
    ...
    return <TipsButton className={buttonClassMap[slot]} receiver={identity} addresses={recipients} />
}
