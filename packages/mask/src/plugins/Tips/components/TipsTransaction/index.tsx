...
import { TransactionConfirmModal, TransactionConfirmModalProps } from '@masknet/shared'

export interface TipsTransactionProps extends TransactionConfirmModalProps {
    shareText: string
    onSubmit?(): void
}
