...
import type { RestoreBackupModalOpenProps } from './RestoreBackupModal/index.js'
...
export const RestoreBackupModal = new SingletonModal<RestoreBackupModalOpenProps>()
