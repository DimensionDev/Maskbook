...
;(function () {
    ...
    function Yt(e, t) {
        return (
            ...
            :   va(Object(t)).forEach(function (r) {
                ...
                try {
                    if (
                        ...
                        a &&
                            (i =
                                g[0] & 2 ? a.return
                                : g[0] ? a.throw || ((i = a.return) && i.call(a), 0)
                                : a.next) &&
                            !(i = i.call(a, g[1])).done)
                    )
                        return i
    ...
    function en(e) {
        ...
        var t = function (a, i) {
            ...
            for (var l = 1, s = a.previousElementSibling; s; )
                (s.tagName === a.tagName && l++, (s = s.previousElementSibling))
    ...
    function nn(e, t) {
        var r,
            a = t == null ? void 0 : t.shouldIgnoreElement
        if (a !== void 0) {
            var i = A(e, Element) ? [e] : []
                    ...
                    if (A(d, Element)) {
                        ...
                        try {
                            for (var R = g.attributes[Symbol.iterator](), F; !(w = (F = R.next()).done); w = !0) {
                                var C = F.value,
                                    N
                                ;(a == null || (N = a.shouldIgnoreAttribute) === null || N === void 0 ?
                                    void 0
                                :   N.call(a, g, C)) !== !0 && (i += '_'.concat(Zt(C.name, 2)))
                            }
                        } catch (I) {
                            ;((k = !0), (H = I))
                        } finally {
    ...
    function ln(e) {
        if (typeof e != 'string')
            throw new TypeError('djb2: expected string, got '.concat(typeof e == 'undefined' ? 'undefined' : D(e)))
    ...
    function xn() {
        ...
        var a = { loadedAsync: !1, params: new URLSearchParams(), src: t, url: r }
    ...
    function dt(e, t) {
        ...
        if (e.length > 0) {
            ...
            if (r[0] === t[0] && r[2] === t[2]) {
                var a,
                    i,
                    l = ((a = r[3]) !== null && a !== void 0 ? a : 1) + ((i = t[3]) !== null && i !== void 0 ? i : 1)
    ...
    function Lt(e) {
        var t, r
        return (t = (r = e.kills) === null || r === void 0 ? void 0 : r.includes('gcs')) !== null && t !== void 0 ?
                t
            :   !1
    }
    function st(e, t) {
    ...
    function Nt(e, t) {
        if (t.isInitialized) {
            ...
            if (r) {
                ...
                a && ne(a, { cs: r, event: 'gcs', source: J, widgetId: e }, t.iframeOrigin)
            }
        }
    }
    function Se(e, t, r) {
    ...
    function tr(e, t, r, a, i, l, s, d, v) {
        ...
        return ''
            .concat(p, '/cdn-cgi/challenge-platform/')
            .concat(g, 'turnstile/f/av0/rch')
            .concat(a, '/')
            .concat(e, '/')
            .concat(t, '/')
            .concat(r.theme, '/')
    ...
    var rr = function (t) {
            var r,
                ...
                d =
                    t.state !== It.FailureFeedbackCode &&
                ...
                v = K(
                    xa,
                    (
                        (r = (i = t.displayLanguage) === null || i === void 0 ? void 0 : i.toLowerCase()) !== null &&
                            r !== void 0
                    ) ?
                        r
                    :   'nonexistent',
                ...
                p = K(
                    Ta,
                    (
                        (a = (l = t.displayLanguage) === null || l === void 0 ? void 0 : l.toLowerCase()) !== null &&
                            a !== void 0
                    ) ?
                        a
                    :   'nonexistent',
            ...
            return (
                s ? wa({ isModeratelyVerbose: p, isSmallerFeedback: d, isVerboseLanguage: v })
                : d && v ? '680px'
                : d && p ? '670px'
                : d ? '650px'
                : v ? '690px'
    ...
    var Fn = function (t, r, a, i, l) {
        ...
        ;(R.append('consent', 'on'),
            ...
            R.append('rayId', a),
            R.append('sitekey', (s = t.params.sitekey) !== null && s !== void 0 ? s : ''),
            R.append('rcV', (d = t.rcV) !== null && d !== void 0 ? d : ''),
            R.append('cfChlOut', (v = t.cfChlOut) !== null && v !== void 0 ? v : ''),
            R.append('cfChlOutS', (p = t.cfChlOutS) !== null && p !== void 0 ? p : ''),
            R.append('mode', (g = t.mode) !== null && g !== void 0 ? g : ''),
            R.append('errorCode', String((w = t.errorCode) !== null && w !== void 0 ? w : 0)),
            R.append('frMd', i),
            R.append('displayLanguage', (k = t.displayLanguage) !== null && k !== void 0 ? k : ''))
        try {
            if (
                typeof navigator != 'undefined' &&
                typeof navigator.sendBeacon == 'function' &&
                navigator.sendBeacon(H, R)
            )
                return !0
        } catch (F) {
        ...
        try {
            return (fetch(H, ke({ body: R, keepalive: !0, method: 'POST', mode: 'no-cors' }, Pn())), !0)
        } catch (F) {
            T(
        ...
        try {
            fetch(H, ke({ body: R, method: 'POST', mode: 'no-cors' }, Pn()))
        } catch (F) {
    ...
    function Vn(e) {
        var t,
            ...
            i =
                (
                    (a = document.querySelector('#'.concat(e))) === null ||
                    a === void 0 ||
    ...
    function qn(e) {
        var t,
            r = Dn((t = Object.getOwnPropertyDescriptor(e, ar)) === null || t === void 0 ? void 0 : t.value)
        if (r) return r
        var a = !0,
            i = !1,
            l = void 0
        try {
            for (var s = Object.getOwnPropertySymbols(e)[Symbol.iterator](), d; !(a = (d = s.next()).done); a = !0) {
                var v = d.value,
                    p,
                    g = Dn((p = Object.getOwnPropertyDescriptor(e, v)) === null || p === void 0 ? void 0 : p.value)
                if (g) return g
            }
        } catch (w) {
            ;((i = !0), (l = w))
    ...
    function Oa(e, t) {
        Object.defineProperty(e, ar, { configurable: !0, enumerable: !1, value: { cleanup: t } })
    }
    function ka(e) {
    ...
    var ir = function (t, r, a, i, l) {
            ...
            ;((I.className = 'cf-turnstile-feedback'),
                (I.id = 'cf-fr-id'),
                (I.style.width = '100vw'),
            ...
            var be = function () {
                ...
                oe = function () {
                    ...
                    ;(ka(C),
                        ...
                        (ae = C.parentNode) === null || ae === void 0 || ae.removeChild(C),
                        l == null || l())
                },
                W = document.createElement('iframe')
            ;((W.id = v),
                W.setAttribute('src', w),
                W.setAttribute('title', 'Turnstile feedback report'),
                W.setAttribute('allow', 'cross-origin-isolated; fullscreen'),
                W.setAttribute('sandbox', 'allow-same-origin allow-scripts allow-popups allow-forms'),
                W.setAttribute('scrolling', 'yes'),
                (W.style.borderWidth = '0px'),
                (W.style.width = '100%'),
                (W.style.height = '100%'),
                (W.style.overflow = 'auto'),
                (r.feedbackIframeOrigin = Je(w)))
            var O = document.createElementNS('http://www.w3.org/2000/svg', 'svg')
            ;(O.setAttribute('tabindex', '0'),
                O.setAttribute('role', 'button'),
                O.setAttribute('aria-label', 'Close feedback report'),
                (O.style.position = 'absolute'),
                (O.style.width = '26px'),
                (O.style.height = '26px'),
                (O.style.zIndex = '2147483647'),
                (O.style.cursor = 'pointer'),
                r.displayRtl === !0 ? (O.style.left = '24px') : (O.style.right = '24px'),
                (O.style.top = '24px'),
            ...
            ;(z.setAttribute('stroke-width', '1'),
                ...
                z.setAttribute('x1', '6'),
                z.setAttribute('x2', '18'),
                z.setAttribute('y1', '18'),
                z.setAttribute('y2', '5'))
            ...
            ;(M.setAttribute('stroke-width', '1'),
                ...
                M.setAttribute('y1', '5'),
                M.setAttribute('y2', '18'),
                r.theme === St.Light ?
                    (z.setAttribute('stroke', '#0A0A0A'), M.setAttribute('stroke', '#0A0A0A'))
                :   (z.setAttribute('stroke', '#F2F2F2'), M.setAttribute('stroke', '#F2F2F2')),
                O.appendChild(z),
                O.appendChild(M),
                I.appendChild(W),
                I.appendChild(O),
                ...
                r.wrapper.parentNode.appendChild(C),
        ...
        vt = function (t) {
            ...
            if (i) {
                ...
                ;(T('Unable to find feedback overlay cleanup handler. Removing overlay without cleanup.'),
    ...
    function Da(e, t, r) {
        ...
        ;((a == null ? void 0 : a.retryTimeout) !== void 0 &&
            (window.clearTimeout(a.retryTimeout), (a.retryTimeout = void 0)),
            T('Cannot find Widget '.concat(r, ', consider using turnstile.remove() to clean up a widget.')),
            ...
            for (var l = e.widgetMap[Symbol.iterator](), s; !(r = (s = l.next()).done); r = !0) {
                ...
                if (!Pa(w) || !p.wrapper.isConnected) {
                    p.watchcat.missingWidgetWarning ||
                        ((p.watchcat.missingWidgetWarning = !0), t.push({ widgetElId: g, widgetId: v }))
                    continue
                }
                ...
                if (
                    ...
                    p.watchcat.lastAckedSeq === 0 && (p.watchcat.lastAckedSeq = e.watchCatSeq),
                    !(p.isComplete || p.isFailed || p.feedbackOpen))
                ) {
                    ...
                    if (
                        ((p.isExecuting || !p.isInitialized || (!p.isStale && !p.isExecuted)) &&
                    ...
                    ne(k, { event: 'meow', seq: e.watchCatSeq, source: J, widgetId: v }, p.iframeOrigin)
                }
            }
        } catch (n) {
            ;((a = !0), (i = n))
    ...
    function ur(e) {
        return (
            (typeof e == 'undefined' ? 'undefined' : D(e)) === 'object' &&
            e !== null &&
            'widgetMap' in e &&
            A(e.widgetMap, Map) &&
    ...
    function Ua(e, t) {
        Object.defineProperty(e, lr, { configurable: !0, enumerable: !1, value: t })
    }
    function Ha(e) {
    ...
    function Wa(e) {
        return !Number.isFinite(e.apiJsReloadBackoffMs) || e.apiJsReloadBackoffMs <= 0 ?
                qe
            :   Math.min(e.apiJsReloadBackoffMs, rt)
    }
    function Va(e) {
    ...
    function Kn(e, t, r) {
        ...
        ;((t.isReady = i.isReady),
            ...
            (t.apiJsReloadBackoffMs = l ? qe : Wa(i)),
            (t.apiJsReloadNextAllowedTsMs = Va(i)),
            (t.apiJsMismatchReloadAttempts = Bn(i, 'apiJsMismatchReloadAttempts')),
            (t.apiJsMismatchReloadCompletedCount = Bn(i, 'apiJsMismatchReloadCompletedCount') + (l ? 1 : 0)),
            (t.apiJsMismatchReloadPending = !1),
            (t.upgradeAttempts = i.upgradeAttempts),
            (t.upgradeCompletedCount = i.upgradeCompletedCount + 1),
            (t.turnstileLoadInitTimeTsMs = X()),
        ...
        try {
            for (var i = m.widgetMap[Symbol.iterator](), l; !(t = (l = i.next()).done); t = !0) {
                var s = Ve(l.value, 2),
                    d = s[0],
                    v = s[1]
                if (v.wrapper.parentElement === e || (v.wrapper !== e && v.wrapper.contains(e)) || v.shadow.contains(e))
                    return d
            }
        } catch (p) {
            ;((r = !0), (a = p))
    ...
    function Ar() {
        var e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {},
            ...
            r = t === void 0 ? !1 : t
        ;((Kt = void 0),
            r || (m.apiJsMismatchReloadPending = !1),
            zt !== void 0 && (window.clearTimeout(zt), (zt = void 0)))
    }
    function la() {
        var e = Kt
        ;(Ar(), e !== void 0 && _t(e))
    ...
    function ti(e) {
        ;(Ar({ preserveMismatchReloadPending: !0 }),
    ...
    function ca(e, t) {
        var r,
            a = (r = e.params['response-field']) !== null && r !== void 0 ? r : !0,
            i = m.isRecaptchaCompatibilityMode,
            l = ''.concat(t, '_response'),
            s = ''.concat(t, '_g_response'),
            d =
                (!a || A(document.querySelector('#'.concat(l)), HTMLInputElement)) &&
                (!i || A(document.querySelector('#'.concat(s)), HTMLInputElement))
        if (!(e.responseElementsBuilt && d)) {
            if (a && !A(document.querySelector('#'.concat(l)), HTMLInputElement)) {
                var v,
                    p = document.createElement('input')
                ;((p.type = 'hidden'),
                    (p.name = (v = e.params['response-field-name']) !== null && v !== void 0 ? v : zr),
                    (p.id = l),
                    e.wrapper.appendChild(p))
            }
    ...
    function Ut(e, t) {
        var r,
            a = (r = t.params.size) !== null && r !== void 0 ? r : Z.Normal,
            i = t.mode
        switch (i) {
            ...
            default:
                b(
                    'Invalid value for parameter "mode", expected "'
                        .concat(ge.NonInteractive, '", "')
                        .concat(ge.Managed, '" or "')
                        .concat(ge.Invisible, '", got "')
                        .concat(String(i), '"'),
                    2818,
                )
        }
    ...
    function ni(e, t) {
        ...
        return (
                (r =
                    (a = e.wrapper.parentNode) === null || a === void 0 ?
                        void 0
                    :   a.querySelector('#'.concat(t, '-fr'))) !== null && r !== void 0
            ) ?
                r
            :   null
    }
    function ai(e) {
        var t, r
        return (
            ((r = e.feedbackPopup) === null || r === void 0 ? void 0 : r.closed) === !0 ?
                ((e.feedbackPopup = void 0), (e.feedbackPopupOrigin = void 0), null)
            : (t = e.feedbackPopup) !== null && t !== void 0 ? t
            : null
        )
    }
    function jt(e, t) {
        var r,
            a,
            i =
                (r = (a = ni(e, t)) === null || a === void 0 ? void 0 : a.contentWindow) !== null && r !== void 0 ?
                    r
                :   null
        if (i !== null) return { targetOrigin: e.feedbackIframeOrigin, targetWindow: i }
        var l = ai(e)
        return { targetOrigin: l === null ? void 0 : e.feedbackPopupOrigin, targetWindow: l }
    }
    function ii(e) {
    ...
    function li(e, t, r) {
        var a,
            i,
            l =
                (a = (i = Ne(t, r)) === null || i === void 0 ? void 0 : i.contentWindow) !== null && a !== void 0 ?
                    a
                :   null,
    ...
    function ci() {
        try {
            ...
            try {
                for (
                    var l = performance.getEntriesByType('resource')[Symbol.iterator](), s;
                    !(r = (s = l.next()).done);
                    r = !0
                ) {
                    var d = s.value
    ...
    var sa = (function () {
            var e = function (n, u, f, c, o, E) {
                        ...
                        return Vr(this, function (Q) {
                            switch (Q.label) {
                                ...
                                case 1:
                                    return (
                                        ...
                                        [
                                            4,
                                            fetch(pe, {
                                                body: JSON.stringify({ secondaryToken: o, sitekey: L }),
                                ...
                                case 3:
                                    return (
                                        (te = Q.sent()),
                                        y(!1, 'Error contacting Turnstile, aborting clearance redemption.'),
                                        [3, 4]
                                    )
                                case 4:
                                    return [2]
                ...
                r = function (n, u, f) {
                    return n.params.execution === at.Render ?
                            !0
                        :   (u === ee.CrashedRetry ||
                                u === ee.FailureRetry ||
                                u === ee.CheckDelays ||
                                u === ee.UpgradeReload) &&
                                n.params.execution === at.Execute &&
                                f
                },
                a = function (n, u, f) {
                    if (
                        ...
                        n.feedbackPopupCloseCheck !== void 0 &&
                            (window.clearInterval(n.feedbackPopupCloseCheck), (n.feedbackPopupCloseCheck = void 0)),
                        Hn(),
                        window.postMessage({ event: 'feedbackClose', source: J, widgetId: f }, '*'),
                        n.pendingRetry)
                    ) {
                ...
                i = function (n, u, f) {
                    var c
                    ;(n.response === void 0 &&
                        b('[Internal Error] Widget was completed but no response was given', 1362),
                        (n.isExecuting = !1),
                        (n.isComplete = !0),
                        da(n, u, n.response),
                        (c = n.cbSuccess) === null || c === void 0 || c.call(n, n.response, f))
                },
                l = function (n) {
                    if (!n) return []
                ...
                s = function () {
                    for (
                        var n = {}, u = [], f = document.querySelectorAll('*'), c = 0;
                        c < f.length && u.length < 50;
                        c++
                    ) {
                ...
                p = function (n, u, f) {
                    for (; n.msgQueue.length > 0; ) {
                        ...
                        ne(
                            f,
                            { cs: c === it.Execute ? ft(n) : void 0, event: c, source: J, widgetId: u },
                            n.iframeOrigin,
                        )
                    }
                },
                    ...
                    if (u) {
                        ...
                        try {
                            for (var y = f[Symbol.iterator](), L; !(o = (L = y.next()).done); o = !0) {
                                var S = L.value
                                Object.getOwnPropertyDescriptor(u, S) !== void 0 &&
                                    u[S] !== void 0 &&
                                    u[S] !== n.params[S] &&
                                    c.push(S)
                            }
                        ...
                        ;(c.length > 0 &&
                            ...
                            u.action !== void 0 &&
                                ...
                                (pr(u.action) ||
                                    b(
                                        'Invalid input for optional parameter "action", got "'.concat(u.action, '"'),
                                        3604,
                                    ),
                                (n.action = u.action)),
                            u.cData !== void 0 &&
                                u.cData !== '' &&
                                (vr(u.cData) ||
                                    b('Invalid input for optional parameter "cData", got "'.concat(u.cData, '"'), 3605),
                                (n.cData = u.cData)),
                            u['after-interactive-callback'] !== void 0 &&
                                (n.cbAfterInteractive = u['after-interactive-callback']),
                            u['before-interactive-callback'] !== void 0 &&
                                (n.cbBeforeInteractive = u['before-interactive-callback']),
                            u.callback !== void 0 && (n.cbSuccess = u.callback),
                            u['expired-callback'] !== void 0 && (n.cbExpired = u['expired-callback']),
                            u['timeout-callback'] !== void 0 && (n.cbTimeout = u['timeout-callback']),
                            u['error-callback'] !== void 0 && (n.cbError = u['error-callback']),
                            u['unsupported-callback'] !== void 0 && (n.cbUnsupported = u['unsupported-callback']),
                            u.chlPageData !== void 0 && u.chlPageData !== '' && (n.chlPageData = u.chlPageData))
                    }
                },
                k = function (n, u, f) {
                ...
                R = function (n, u, f) {
                    ...
                    ;((_.isResetting = !0),
                        ...
                        (_.errorCode = void 0),
                        (_.frMd = void 0),
                        (_.autoFeedbackSent = !1),
                        (_.watchcat.overrunBeginSeq = 0),
                        (_.watchcat.lastAckedSeq = 0),
                        (_.watchcat.seq = 0),
                        r(_, n, y) && (_.msgQueue.push(it.Execute), (_.isExecuted = !0), (_.isExecuting = !0)))
                    var L = G(E),
                        S = _.shadow.querySelector('#'.concat(L))
                    ;(S === null && b('Widget '.concat(E, ' to reset was not found.'), 3330),
                        (_.params.appearance === _e.InteractionOnly || _.params.appearance === _e.Execute) && ia(S),
                        _.params.sitekey === null && b('Unexpected Error: Sitekey is null', 3347))
                    var P = S.cloneNode()
                    ...
                    ;((P.src = q),
                        aa(P, _),
                        (_.iframeOrigin = Je(q)),
                        (o = S.parentNode) === null || o === void 0 || o.replaceChild(P, S),
                        Tr(_, L),
                        _.retryTimeout !== void 0 && window.clearTimeout(_.retryTimeout))
                },
                F = function (n, u) {
                    var f = G(n),
                    ...
                    ;(document.querySelectorAll(c.join(', ')).forEach(function (o) {
                        ...
                        je(u),
                        u.wrapper.remove(),
                        u.retryTimeout !== void 0 && window.clearTimeout(u.retryTimeout),
                ...
                I = function (n, u, f, c) {
                    ...
                    if (typeof n == 'string') {
                        ...
                        if (ie === null) {
                            ...
                            var de,
                                B = m.widgetMap.get(ie),
                                ht =
                                    (de = B == null ? void 0 : B.wrapper.parentElement) !== null && de !== void 0 ?
                                        de
                                    :   null
                            if (ht !== null && ra(f, B)) ((te = ht), (Q = { widget: B, widgetId: ie }))
                    ...
                    if (Q === void 0) {
                        ...
                        if (Ie !== null) {
                            ...
                            if (se !== void 0 && ra(f, se) && se.wrapper.parentElement === te)
                                Q = { widget: se, widgetId: Ie }
                    ...
                    if (Xe !== void 0) {
                        var h = Object.assign(Xe, u),
                            ...
                            bt = h.chlPageData,
                            xe = h.sitekey
                        ;((h.theme = (o = h.theme) !== null && o !== void 0 ? o : St.Auto),
                            (h.retry = (E = h.retry) !== null && E !== void 0 ? E : At.Auto),
                            (h.execution = (_ = h.execution) !== null && _ !== void 0 ? _ : at.Render),
                            (h.appearance = (y = h.appearance) !== null && y !== void 0 ? y : _e.Always),
                            (h['retry-interval'] = Zn(h['retry-interval'], Gr)),
                            (h['expiry-interval'] = Zn(h['expiry-interval'], (cn - dn) * 1e3)),
                            (h.size = (L = h.size) !== null && L !== void 0 ? L : Z.Normal))
                        var Et = h.callback,
                        ...
                        ;(typeof xe != 'string' &&
                            b(
                                'Invalid or missing type for parameter "sitekey", expected "string", got "'.concat(
                                    typeof xe == 'undefined' ? 'undefined' : D(xe),
                                    '"',
                                ),
                                3588,
                            ),
                            Gn(xe) || b('Invalid input for parameter "sitekey", got "'.concat(xe, '"'), 3589),
                            mr(h.size) ||
                                b(
                                    'Invalid type for parameter "size", expected normal|compact, got "'
                                        .concat(String(h.size), '" ')
                                        .concat(D(h.size)),
                                    3590,
                                ),
                            cr(h.theme) ||
                            ...
                            dr(h.retry) ||
                                b(
                                    'Invalid type for parameter "retry", expected never|auto, got "'
                                        .concat(String(h.retry), '" ')
                                        .concat(D(h.retry)),
                                    3592,
                                ),
                            (h.language === void 0 || h.language === '') && (h.language = 'auto'),
                            yr(h.language) ||
                                (T(
                        ...
                        gr(Te) ?
                            (h['refresh-expired'] = Te)
                        :   b(
                                'Invalid type for parameter "refresh-expired", expected never|manual|auto, got "'
                                    .concat(String(Te), '" ')
                                    .concat(typeof Te == 'undefined' ? 'undefined' : D(Te)),
                                3603,
                            )
                        var ve = (P = h['refresh-timeout']) !== null && P !== void 0 ? P : nt.Auto
                        ;(_r(ve) ?
                            (h['refresh-timeout'] = ve)
                        :   b(
                                'Invalid type for parameter "refresh-timeout", expected never|manual|auto, got "'
                                    .concat(String(ve), '" ')
                                    .concat(typeof ve == 'undefined' ? 'undefined' : D(ve)),
                                3603,
                            ),
                            pr(Ae) || b('Invalid input for optional parameter "action", got "'.concat(Ae, '"'), 3604),
                            vr(Oe) || b('Invalid input for optional parameter "cData", got "'.concat(Oe, '"'), 3605))
                        var $ = document.createElement('iframe'),
                            Ze = document.createElement('div'),
                            Tt = Ze.attachShadow({ mode: 'closed' }),
                            De = v(),
                            re = G(De),
                            Fe = [],
                        ...
                        ;(we === void 0 && b('Turnstile Initialization Error ', 3606),
                            we.chlPageData !== void 0 && we.chlPageData !== '' && Ir(),
                            ($.style.display = 'none'),
                            ($.style.border = 'none'),
                        ...
                        return (
                            K(
                                (
                                    (q =
                                        (
                                            (pe = document.featurePolicy) === null ||
                                            pe === void 0 ||
                                            (le = pe.features) === null ||
                                            le === void 0
                                        ) ?
                                            void 0
                                        :   le.call(pe)) !== null && q !== void 0
                                ) ?
                                    q
                                :   [],
                                Qt,
                            ) && Mr.push(Qt),
                            $.setAttribute('allow', Mr.join('; ')),
                            $.setAttribute('sandbox', 'allow-same-origin allow-scripts allow-popups'),
                            ($.id = re),
                            ($.tabIndex = (ue = h.tabindex) !== null && ue !== void 0 ? ue : 0),
                            ($.title = 'Widget containing a Cloudflare security challenge'),
                            Tt.appendChild($),
                            ca(we, re),
                            Q && F(Q.widgetId, Q.widget),
                            te.appendChild(Ze),
                            (we.widgetRenderEndTimeTsMs = X()),
                            re
                        )
                    }
                },
                    ...
                    if (u === J) {
                        ...
                        if (!(typeof f != 'string' || f === '' || !m.widgetMap.has(f))) {
                            ...
                            if (o !== void 0)
                                switch (n.event) {
                                    case 'init': {
                                        ;((o.widgetInitStartTimeTsMs = X()),
                                            (o.kills = n.kills),
                                            Lt(o) && (o.gcs.length = 0))
                                        var E = o.shadow.querySelector('#'.concat(c))
                                        ;(A(E, HTMLElement) ||
                                            b('Cannot initialize Widget, Element not found (#'.concat(c, ').'), 3074),
                                            (o.mode = n.mode),
                                            (o.nextRcV = n.nextRcV),
                                            o.mode === ge.Invisible &&
                                                o.params['refresh-expired'] === Be.Manual &&
                                                T(
                                            ...
                                            o.mode !== ge.Managed &&
                                                o.params['refresh-timeout'] !== nt.Auto &&
                                                T(
                                                    'setting refresh-timeout has no effect on an invisible/non-interactive widget and will be ignored.',
                                                ),
                                            (
                                                o.params.appearance === _e.Always ||
                                                (o.isExecuting && o.params.appearance === _e.Execute)
                                            ) ?
                                                Ut(E, o)
                                            :   ia(E),
                                            (E.style.display = ''))
                                        var _ = Ne(o, c)
                                        ;(_ || b('Received state for an unknown widget: '.concat(n.widgetId), 3078),
                                            ne(_, { event: 'init', source: J, widgetId: n.widgetId }, o.iframeOrigin))
                                        break
                                    }
                                    case 'translationInit': {
                                        ...
                                        A(y, HTMLElement) ||
                                            b('Cannot initialize Widget, Element not found (#'.concat(c, ').'), 3074)
                                        var L = new Map()
                                        ;((o.displayLanguage = n.displayLanguage),
                                            (o.displayRtl = n.displayRtl),
                                            Object.keys(n.translationData).forEach(function (He) {
                                    ...
                                    case 'reject': {
                                        ...
                                        ;((o.isExecuting = !1),
                                            A(S, HTMLElement) ||
                                                b(
                                                    'Cannot initialize Widget, Element not found (#'.concat(c, ').'),
                                                    3075,
                                                ))
                                    ...
                                    case 'complete': {
                                        ...
                                        if (
                                            ...
                                            !Ge('scs', o) &&
                                            ((o.scs = n.scs),
                                            o.params['session-continuity-persist'] === !0 && !Ge('scs_persist', o))
                                        ) {
                                        ...
                                        n.sToken !== void 0 && n.sToken !== '' ?
                                            e(o, n.widgetId, c, n.token, n.sToken, n.chlId)
                                        :   i(o, c, !1)
                                        break
                                    }
                                    case 'fail': {
                                        ...
                                        if (
                                            (typeof Ee == 'string' && Ee !== '' && d(o, Ee, f),
                                            n.cfChlOut !== void 0 && n.cfChlOut !== '' && (o.cfChlOut = n.cfChlOut),
                                            n.cfChlOutS !== void 0 && n.cfChlOutS !== '' && (o.cfChlOutS = n.cfChlOutS),
                                            n.code !== void 0 && n.code !== 0 && (o.errorCode = n.code),
                                            n.aC !== void 0 && n.aC !== '')
                                        ) {
                                            var te
                                        ...
                                        ;((o.isExecuting = !1),
                                            (o.isFailed = !0),
                                            (o.isInitialized = !0),
                                            n.frMd !== void 0 && n.frMd !== '' && (o.frMd = n.frMd),
                                            Tr(o, c))
                                        var Q = o.cbError,
                                        ...
                                        if (Q !== void 0) {
                                            var B
                                            Q(String((B = n.code) !== null && B !== void 0 ? B : pn)) === !0 ?
                                                ce && o.params.retry === At.Auto && !o.isResetting && t(o, c, ie)
                                            :   (n.code !== void 0 && n.code !== 0 && T('Error: '.concat(n.code, '.')),
                                                ce && t(o, c, ie))
                                        } else
                                            n.code !== void 0 && n.code !== 0 ?
                                                (ce && t(o, c, ie), b('Error: '.concat(n.code), 3076))
                                            :   t(o, c, !1)
                                        break
                                    }
                                    case 'feedbackInit': {
                                        ...
                                        if (((o.feedbackOpen = !0), o.retryTimeout !== void 0)) {
                                            ...
                                            ;(clearTimeout(o.retryTimeout),
                                                ...
                                                ((Pe = (se = o).pendingRetry) !== null && Pe !== void 0) ||
                                                    (se.pendingRetry = { crashed: !1 }))
                                        }
                                        ;(Un(),
                                            window.postMessage(
                                                { event: 'feedbackOpen', source: J, widgetId: n.widgetId },
                                                '*',
                                            ),
                                    ...
                                    case 'requestFeedbackData': {
                                        ...
                                        ;(A(Xe, HTMLElement) ||
                                            ...
                                            ne(
                                                Xe,
                                                { event: 'requestTurnstileResults', source: J, widgetId: n.widgetId },
                                                o.iframeOrigin,
                                            ))
                                        break
                                    }
                                    case 'turnstileResults': {
                                        ...
                                        er(
                                            Et,
                                            {
                                                ...
                                                cfChlOutS:
                                                    (Ae = o.cfChlOutS) !== null && Ae !== void 0 ? Ae : n.cfChlOutS,
                                    ...
                                    case 'closeFeedbackReportIframe': {
                                        ...
                                        ;(Gt || b('Received state for an unknown widget: '.concat(n.widgetId), 3078),
                                            vt(''.concat(c, '-fr')),
                                            je(o),
                                            a(o, c, n.widgetId))
                                        break
                                    ...
                                    case 'tokenExpired': {
                                        var Ye,
                                            Xt = n.token
                                        ;((o.isExpired = !0),
                                            (Ye = o.cbExpired) === null || Ye === void 0 || Ye.call(o, Xt),
                                            o.params['refresh-expired'] === Be.Auto &&
                                                !o.isResetting &&
                                                R(ee.AutoExpire, c))
                                        break
                                    }
                                    case 'interactiveTimeout': {
                                        ...
                                        if (
                                            (xt ? xt() : (
                                                o.params['refresh-timeout'] === nt.Never &&
                                                !o.isResetting &&
                                                T(
                                            ...
                                            o.params['refresh-timeout'] === nt.Auto && !o.isResetting)
                                        ) {
                                    ...
                                    case 'interactiveBegin': {
                                        var $e,
                                            Te = o.shadow.querySelector('#'.concat(c))
                                        ;(A(Te, HTMLElement) ||
                                            b('Cannot layout widget, Element not found (#'.concat(c, ').'), 3076),
                                            ($e = o.cbBeforeInteractive) === null || $e === void 0 || $e.call(o),
                                            o.params.appearance === _e.InteractionOnly && Ut(Te, o))
                                        break
                                    }
                                    case 'interactiveEnd': {
                                        var ve
                                    ...
                                    case 'requestExtraParams': {
                                        ...
                                        var $ = Ne(o, c)
                                        ;($ || b('Received state for an unknown widget: '.concat(n.widgetId), 3078),
                                            (o.isResetting = !1))
                                        var Ze = {},
                                            Tt = X(),
                                            De = {
                                        ...
                                        if (
                                            ...
                                            if (Fe !== null && Fe !== '') {
                                                ...
                                                try {
                                                    var Ue
                                                    re =
                                                        (Ue = localStorage.getItem(et)) !== null && Ue !== void 0 ?
                                                            Ue
                                                        :   void 0
                                                } catch (He) {}
                                            }
                                        }
                                        ;(re !== void 0 && re !== '' && re.length > Zr && (re = void 0),
                                            ne(
                                                $,
                                                ke(
                                                    {
                                                        ...
                                                        apiJsMismatchReloadCompletedCount:
                                                            m.apiJsMismatchReloadCompletedCount,
                                                        ...
                                                        timeInitMs:
                                                            o.widgetInitStartTimeTsMs - o.widgetRenderEndTimeTsMs,
                                                        timeLoadInitMs: X() - m.turnstileLoadInitTimeTsMs,
                                                        timeParamsMs:
                                                            o.widgetParamsStartTimeTsMs - o.widgetInitStartTimeTsMs,
                                                        timeRenderMs:
                                                            o.widgetRenderEndTimeTsMs - o.widgetRenderStartTimeTsMs,
                                                        timeTiefMs: X() - Tt,
                ...
                j = Yt(ke({}, Y), {
                    ...
                    execute: function (n, u) {
                        ...
                        if (o === null) {
                            ...
                            ;((c = !0),
                                _ == null && b('Failed to render widget', 43522),
                                (o = (E = lt(_)) !== null && E !== void 0 ? E : M(n)),
                                o === null && b('Failed to render widget', 43522))
                        }
                        ...
                        if (y !== void 0) {
                            ...
                            if (((y.isExecuting = !0), y.response !== void 0 && y.response !== '')) {
                                ...
                                ;((y.isExecuting = !1),
                                    ...
                                    L && Nt(o, y),
                                    (P = y.cbSuccess) === null || P === void 0 || P.call(y, y.response, !1))
                                return
                            }
                            ;(y.isExpired &&
                                T(
                                ...
                                y.isStale && (R(ee.StaleExecute, S), (y.isExecuting = !0)),
                                (y.isResetting || !y.isInitialized) && y.msgQueue.push(it.Execute),
                                (y.isExecuted = !0))
                            var q = Ne(y, S)
                            if (
                                (q ||
                                    ((y.isExecuting = !1), b('Widget '.concat(S, ' to execute was not found'), 43522)),
                                y.isResetting || !y.isInitialized)
                            )
                                return
                            ...
                            ;(y.params.appearance === _e.Execute && Ut(q, y),
                                g(y) && ne(q, { cs: ft(y), event: 'execute', source: J, widgetId: o }, y.iframeOrigin))
                        }
                    },
                    ...
                    isExpired: function (n) {
                        ...
                        if (typeof n == 'undefined') {
                            ...
                            if (c !== void 0) {
                                ...
                                return (
                                    E !== void 0 && Se(c, E, f),
                                    (o = E == null ? void 0 : E.isExpired) !== null && o !== void 0 ? o : !1
                                )
                            }
                            b('Could not find a widget', 43794)
                        }
                        ...
                        return (
                            y && Se(_, y, f),
                            (u = y == null ? void 0 : y.isExpired) !== null && u !== void 0 ? u : !1
                        )
                    },
                    ready: function (n) {
                        ;(m.scriptWasLoadedAsync &&
                            (T(
                            ...
                            typeof n != 'function' &&
                                b(
                                    'turnstile.ready() expected a "function" argument, got "'.concat(
                                        typeof n == 'undefined' ? 'undefined' : D(n),
                                        '"',
                                    ),
                                    3841,
                                ))
            ...
            return (
                ...
                { runImplicitRender: oe, turnstile: j }
            )
        })(),
        di = function () {
    ...
    function si(e) {
        ...
        if ((d !== null && d !== '' && (mr(d) ? (i.size = d) : T('Unknown data-size value: "'.concat(d, '".'))), 0))
            var v
        ...
        w !== null &&
            ...
            (dr(w) ?
                (i.retry = w)
            :   T('Invalid data-retry value: "'.concat(w, ", expected either 'never' or 'auto'\".")))
        var k = e.getAttribute('data-retry-interval')
        if (k !== null && k !== '') {
            var H = Number.parseInt(k, 10)
            sr(H) ?
                (i['retry-interval'] = H)
            :   T('Invalid data-retry-interval value: "'.concat(k, ', expected an integer value > 0 and < 900000".'))
        }
        ...
        if (R !== null && R !== '') {
            ...
            fr(F) ?
                (i['expiry-interval'] = F)
            :   T('Invalid data-expiry-interval value: "'.concat(F, ', expected an integer value > 0 and < 360000".'))
        }
        ...
        C !== null &&
            ...
            (gr(C) ?
                (i['refresh-expired'] = C)
            :   T('Unknown data-refresh-expired value: "'.concat(C, ", expected either: 'never', 'auto' or 'manual'.")))
        var N = e.getAttribute('data-refresh-timeout')
        N !== null &&
            N !== '' &&
            (_r(N) ?
                (i['refresh-timeout'] = N)
            :   T('Unknown data-refresh-timeout value: "'.concat(N, ", expected either: 'never', 'auto' or 'manual'.")))
        ...
        ;(oe.forEach(function (j) {
            ...
            (i['feedback-enabled'] =
                (
                    (t = Ht(e.getAttribute('data-feedback-enabled'), !0, function (j) {
            ...
            (i['response-field'] =
                (
                    (r = Ht(e.getAttribute('data-response-field'), !0, function (j) {
        ...
        O !== null &&
            ...
            (br(O) ?
                (i.execution = O)
            :   T('Unknown data-execution value: "'.concat(O, ", expected either: 'render' or 'execute'.")))
    ...
    ;((Le = !1),
        (U = xn()),
        (m.scriptWasLoadedAsync = (Vt = U == null ? void 0 : U.loadedAsync) !== null && Vt !== void 0 ? Vt : !1),
        (m.scriptUrl = (qt = U == null ? void 0 : U.src) !== null && qt !== void 0 ? qt : 'undefined'),
        (m.scriptUrlParsed = U == null ? void 0 : U.url),
        (U == null ? void 0 : U.params) !== void 0 &&
            U.params !== null &&
            ((Ke = U.params.get('compat')),
            (Ke == null ? void 0 : Ke.toLowerCase()) === 'recaptcha' ?
                typeof window.grecaptcha == 'undefined' ?
                    (T('Compatibility layer enabled.'), (m.isRecaptchaCompatibilityMode = !0), (window.grecaptcha = Wt))
                :   T('grecaptcha is already defined. The compatibility layer will not be enabled.')
            :   Ke !== null && T('Unknown value for api.js?compat: "'.concat(Ke, '", ignoring.')),
            U.params.forEach(function (e, t) {
                K(['onload', 'compat', '_cb', '_upgrade', '_reload', 'render'], t) ||
                    T('Unknown parameter passed to api.js: "?'.concat(t, '=...", ignoring.'))
            }),
            (Le = U.params.get('_upgrade') === 'true'),
            (he = U.params.get('onload')),
            he !== null &&
                he !== '' &&
                !Le &&
                setTimeout(function () {
                    ...
                    e === void 0 ?
                        (T(
                            "Unable to find onload callback '"
                                .concat(he, "' immediately after loading, expected 'function', got '")
                                .concat(D(Rr(he)), "'."),
                        ),
                        setTimeout(function () {
                            var t = Sr(he)
                            t === void 0 ?
                                T(
                                    "Unable to find onload callback '"
                                        .concat(he, "' after 1 second, expected 'function', got '")
                                        .concat(D(Rr(he)), "'."),
                                )
                            :   t()
                        }, 1e3))
        ...
        (gt = 'turnstile' in window),
        (fe = gt ? ta(window.turnstile) : void 0),
        (Bt =
            gt && Le ?
                Kn(window.turnstile, m, function () {
                    var e
                    ;((window.turnstile = Wt), (e = ta(Wt)) === null || e === void 0 || e.reloadAfterUpgrade(), or(m))
                })
            :   !1),
        Bt && (fe == null || fe.clearPendingApiJsReloadRequest()),
        gt && Le && !Bt ?
            (T('Turnstile upgrade state was missing. Keeping the existing Turnstile instance.'),
            fe == null || fe.rejectPendingApiJsReloadRequest(),
            fe == null || fe.rearmTimedUpgrade())
        : gt && !Le ? T('Turnstile already has been loaded. Was Turnstile imported multiple times?')
        : (Bt || (window.turnstile = Wt),
            Le ||
                ((U == null || (Jt = U.params) === null || Jt === void 0 ? void 0 : Jt.get('render')) !== 'explicit' &&
                    kr.push(di),
                document.readyState === 'complete' || document.readyState === 'interactive' ?
                    setTimeout(na, 0)
                :   window.addEventListener('DOMContentLoaded', na)),
            Or()))
