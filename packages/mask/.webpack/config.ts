...
const wasm2jsLoader = require.resolve('./loaders/wasm2js-loader.cjs')
const splineWasm2JsLoader = require.resolve('./loaders/spline-wasm2js-loader.cjs')
const disableLongWasmLoader = require.resolve('./loaders/disable-long-wasm-loader.cjs')
