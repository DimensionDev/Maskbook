...
function getStyleProps() {
    ...
    const spanEle = profileTabUnselectedSelector().evaluate()?.querySelector(':scope div span')
    const selectedSpanEle = profileTabSelectedSelector().evaluate()?.querySelector(':scope div span')
...
function styleTab(textColor: string, borderColor: string) {
    ...
    const borderEle = ele.querySelector(':scope span ~ div:last-child')! as HTMLElement
