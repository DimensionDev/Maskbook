...
export const searchLastMetaSelector: () => LiveSelector<E, true> = () =>
    querySelector<E>('head >  meta[property="og:image"]:last-child')
export const searchLastLinkSelector: () => LiveSelector<E, true> = () =>
    querySelector<E>('head > link[href^="https://twitter.com"]:last-child')
