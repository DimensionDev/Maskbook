...
export const POLYGON_API_URL = 'https://polygon.api.barnbridge.com/api/'
...
export const COLOR_BARNBRIDGE_BACKGROUND_LIGHT = '#f8f8f9'
export const COLOR_BARNBRIDGE_BACKGROUND_CARD_DARK = '#282c30'
export const COLOR_BARNBRIDGE_BACKGROUND_CARD_LIGHT = '#fff'
export const COLOR_SY_SENIOR_TEXT = '#00d395'
export const COLOR_SY_JUNIOR_TEXT = '#a26ee3'
export const COLOR_BARNBRIDGE_TEXT_LIGHT = '#060a0d'
export const COLOR_BARNBRIDGE_TEXT_DARK = '#fff'
