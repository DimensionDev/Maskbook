...
export function OfferTabActionBar(props: OfferTabActionBarProps) {
    ...
    const { onOpen: onOpenAcceptOfferDialog } = useRemoteControlledDialogEvent(
        PluginCollectibleMessage.events.acceptOfferDialogEvent,
    )
    ...
    return (
        <Box sx={{ padding: 2 }} display="flex" justifyContent="flex-end">
            ...
            <ActionButton
                ...
                {t('plugin_collectible_accept_offer')}
            </ActionButton>
        </Box>
    )
}
