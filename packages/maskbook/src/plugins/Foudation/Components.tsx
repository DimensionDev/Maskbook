...
export function HelloWorld(props: any) {
    return <h1 style={{ background: 'white', color: 'black' }}>Foundation</h1>
}
export function GlobalComponent() {
    return <Box position="fixed" top={233} left={233} children="Foundation nft" bgcolor="white" color="black" />
}
