...
import { GameeTokenCard } from './TokenCard'
...
export interface GameePacketProps {
    payload: GameeJSONPayload
}

export function GammePacket(props: GameePacketProps) {
    // fetch images
    ...
    const tokens = useTokens(payload.state, electionToken)
