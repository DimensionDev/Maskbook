...
const AirdropIconSVG = (
    <svg viewBox='0 0 70 79' fill="none" xmlns="http://www.w3.org/2000/svg">
        <g style={{ mixBlendMode: 'luminosity' }}>
            <path d="M35.523 70.684l-12.818-1.13 4.489-11.115 12.817 1.13-4.488 11.115z" fill="url(#paint0_linear)" />
            <path d="M12.627 61.571l10.058 7.966 4.488-11.116-10.058-7.965-4.488 11.115z" fill="url(#paint1_linear)" />
            ...
            <path
                ...
                fill="#7D63FD"
            />
            <path d="M29.933 51.6L17.1 50.463l10.074 7.98 12.833 1.136L29.933 51.6z" fill="#A291EC" />
            <path
                d="M15.085 23.35s7.58 2.652 7.6 8.526c0 0 11.926-2.642 22.271 8.861 0 0 5.713-4.767 15.328.623l-1.685-7.621-21.316-10.88-14.076-5.6-8.122 6.091z"
                fill="url(#paint2_linear)"
            />
            <path d="M23.005 55.144l12.834 1.137-2.298-1.824-12.834-1.136 2.298 1.823z" fill="#694CE4" />
            <path d="M31.969 58.892l-10.074-7.98 2.93.258L34.9 59.149l-2.93-.257z" fill="#694CE4" />
            <path
                d="M33.718 30.023c3.128-.574 6.653-.308 10.114.947 3.465 1.255 6.335 3.308 8.355 5.75.36.108.72.228 1.08.358 2.752.997 5.127 2.497 7 4.295l.125-.3c5.035-12.477-1.003-26.619-13.488-31.586-12.484-4.967-26.686 1.122-31.72 13.6-.038.093-.073.187-.11.28 3.173-.618 6.765-.367 10.293.911 3.464 1.256 6.331 3.306 8.35 5.745z"
                fill="#F0F2F6"
            />
            <path
                opacity=".56"
            ...
            />
            <path
                d="M28.409 55.096L60.317 41.38l-.04-.092-31.545 13.557 23.516-18.123-.062-.081-22.402 17.265 15.224-13.16-.067-.077-16.478 14.244 5.335-24.918-.1-.02-5.32 24.847-5.622-22.985-.099.025 5.52 22.568-13.023-31.121-.094.04 13.268 31.707-.026.12.048-.037.001.005.058-.048z"
                fill="#fff"
            />
            <path
            ...
            />
            <path
                d="M60.272 41.374l.125-.3c5.033-12.47-1.002-26.602-13.48-31.566 0 0 12.577 8.503 5.278 27.215.36.108.72.227 1.08.358 2.751.996 5.125 2.496 6.997 4.293z"
        ...
        <defs>
            <linearGradient
                ...
                <stop stopColor="#8672EA" />
                <stop offset="1" stopColor="#6347EF" />
            </linearGradient>
            <linearGradient
                id="paint1_linear"
                x1="14.488"
                ...
                y2="63.776"
                gradientUnits="userSpaceOnUse">
                <stop stopColor="#B2A3FA" />
                <stop offset="1" stopColor="#B2A3FF" />
            </linearGradient>
            <linearGradient
                id="paint2_linear"
                x1="38.367"
                ...
                y2="39.755"
                gradientUnits="userSpaceOnUse">
                <stop stopColor="#351BB2" />
                <stop offset="1" stopColor="#A592FF" />
            </linearGradient>
            <linearGradient
                id="paint3_linear"
                x1="58.213"
                ...
                y2="36.927"
                gradientUnits="userSpaceOnUse">
                <stop stopColor="#9179FF" />
                <stop offset="1" stopColor="#DFD9FF" />
            </linearGradient>
            <linearGradient
                id="paint4_linear"
                x1="47.98"
                ...
                y2="28.133"
                gradientUnits="userSpaceOnUse">
                <stop stopColor="#B19FFF" />
                <stop offset="1" stopColor="#6F58D8" stopOpacity="0" />
            </linearGradient>
            <linearGradient
                id="paint5_linear"
                x1="51.643"
...
export function AirdropIcon(props: SvgIconProps) {
    return <SvgIcon {...props}>{AirdropIconSVG}</SvgIcon>
}
