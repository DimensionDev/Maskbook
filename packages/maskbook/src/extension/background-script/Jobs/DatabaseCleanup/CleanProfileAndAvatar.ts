...
// }
//
// export async function cleanRelationDB(anotherList: IdentifierMap<ProfileIdentifier, undefined>) {
//     await consistentPersonaDBWriteAccess(async (t) => {
//         for await (const x of t.objectStore('relations')) {
//             const id = Identifier.fromString(x.value.profile, ProfileIdentifier).unwrap()
//             if (anotherList.get(id)) {
//                 await x.delete()
//             }
//         }
//     })
