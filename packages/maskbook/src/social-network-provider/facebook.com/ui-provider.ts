...
import { uploadToPostBoxFacebook, imageShuffleUploadToPostBoxFacebook } from './tasks/uploadToPostBox'
...
export const facebookUISelf = defineSocialNetworkUI({
    ...
    taskImageShuffleUploadToPostBox: imageShuffleUploadToPostBoxFacebook,
