...
export const postsContentSelector = () =>
    querySelectorAll(
        [
            ...
            '[data-testid="tweet"] + div [role="link"] div[lang]', // quoted tweet in detail page for new twitter
            '[data-testid="tweet"] > div:last-child [role="link"] div[lang]', // quoted tweet in timeline page for new twitter
        ].join(),
    ).concat(
