...
export const [useMoonriverNetworkTradeProvider] = createGlobalState(
    Services.Settings.getMoonriverNetworkTradeProvider,
    Messages.events.moonriverNetworkTradeProviderSettings.on,
)
