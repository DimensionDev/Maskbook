import { RestoreBlue as RestoreBlueIcon, SignUpAccount as SignUpAccountIcon } from '@masknet/icons'
...
export const SignUpAccountLogo = () => <SignUpAccountIcon size={96} />

export const RestoreBlueLogo = () => <RestoreBlueIcon size={96} />
