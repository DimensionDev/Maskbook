...
export const LinkOutIcon = createPaletteAwareIcon(
    ...
    <>
        ...
        />
        <path d="M12.5 2.5H17.5V7.5" stroke="#111432" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round" />
        <path
    ...
    <>
        <path
            ...
            strokeLinejoin="round"
        />
        <path d="M12.5 2.5H17.5V7.5" stroke="white" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round" />
        <path
