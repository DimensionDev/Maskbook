...
export interface Vbnb extends BaseContract {
    constructor(jsonInterface: any[], address?: string, options?: ContractOptions): Vbnb
    clone(): Vbnb
    methods: {
        ...
        liquidateBorrow(borrower: string, vTokenCollateral: string): PayableTransactionObject<void>
