...
export interface Vbep extends BaseContract {
    constructor(jsonInterface: any[], address?: string, options?: ContractOptions): Vbep
    clone(): Vbep
    methods: {
        ...
        _becomeImplementation(data: string | number[]): NonPayableTransactionObject<void>

        _reduceReserves(reduceAmount: number | string | BN): NonPayableTransactionObject<string>

        _resignImplementation(): NonPayableTransactionObject<void>
        ...
        isVToken(): NonPayableTransactionObject<boolean>
    ...
    once(event: 'RedeemFee', options: EventOptions, cb: Callback<RedeemFee>): void
