...
export interface QiAvax extends BaseContract {
    constructor(jsonInterface: any[], address?: string, options?: ContractOptions): QiAvax
    clone(): QiAvax
    methods: {
        _acceptAdmin(): NonPayableTransactionObject<string>

        _addReserves(): PayableTransactionObject<string>
        ...
        liquidateBorrow(borrower: string, qiTokenCollateral: string): PayableTransactionObject<void>
