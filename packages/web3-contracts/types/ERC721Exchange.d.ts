...
export interface ERC721Exchange extends BaseContract {
    constructor(jsonInterface: any[], address?: string, options?: ContractOptions): ERC721Exchange
    clone(): ERC721Exchange
    methods: {
