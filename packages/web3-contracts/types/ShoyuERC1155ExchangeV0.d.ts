...
export interface ShoyuERC1155ExchangeV0 extends BaseContract {
    constructor(jsonInterface: any[], address?: string, options?: ContractOptions): ShoyuERC1155ExchangeV0
    clone(): ShoyuERC1155ExchangeV0
    methods: {
