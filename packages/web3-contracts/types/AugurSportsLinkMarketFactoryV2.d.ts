...
export interface AugurSportsLinkMarketFactoryV2 extends BaseContract {
    constructor(jsonInterface: any[], address?: string, options?: ContractOptions): AugurSportsLinkMarketFactoryV2
    clone(): AugurSportsLinkMarketFactoryV2
    methods: {
