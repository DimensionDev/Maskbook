...
export namespace RSS3BaseAPI {
    ...
    export interface Provider {
        createRSS3(address: string): RSS3.default
        getFileData<T>(rss3: RSS3.default, address: string, key: string): Promise<T | undefined>
        setFileData<T>(rss3: RSS3.default, address: string, key: string, data: T): Promise<T>
