import { PROVIDER_DESCRIPTORS, NETWORK_DESCRIPTORS } from '@masknet/web3-shared-flow'
...
export const FlowChainResolver = new ChainResolverAPI_Base(FlowWeb3StateRef)
export const FlowExplorerResolver = new ExplorerResolverAPI_Base(FlowWeb3StateRef)
