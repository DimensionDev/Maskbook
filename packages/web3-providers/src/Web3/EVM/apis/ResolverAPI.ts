...
export const ChainResolver = new ChainResolverAPI_Base(CHAIN_DESCRIPTORS, Web3StateRef)
export const ExplorerResolver = new ExplorerResolverAPI_Base(CHAIN_DESCRIPTORS, Web3StateRef)
