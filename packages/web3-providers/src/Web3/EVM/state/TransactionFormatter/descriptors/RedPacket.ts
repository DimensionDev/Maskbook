...
import HappyRedPacketV4ABI from '@masknet/web3-contracts/abis/HappyRedPacketV4.json' assert { type: 'json' }
import NftRedPacketABI from '@masknet/web3-contracts/abis/NftRedPacket.json' assert { type: 'json' }
