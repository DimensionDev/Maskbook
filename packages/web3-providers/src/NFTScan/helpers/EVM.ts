...
import { getJSON, resolveNonFungibleTokenEventActivityType, getPaymentToken, getNFTFullName } from '../../helpers.js'
...
export function createNonFungibleAsset(
    ...
    return {
        ...
        metadata: {
            chainId,
            name: getNFTFullName(contractName, payload?.name || asset.name, asset.token_id),
            symbol,
            description,
            imageURL: mediaURL,
            mediaURL,
