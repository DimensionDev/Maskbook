...
export interface AugurSportsLinkMarketFactory extends BaseContract {
    ...
    methods: {
        ...
        createMarket(_payload: string | number[]): NonPayableTransactionObject<string[]>

        decodeCreation(_payload: string | number[]): NonPayableTransactionObject<{
            _eventId: string
            _homeTeamId: string
            _awayTeamId: string
            ...
            _homeSpread: string
            _totalScore: string
            _createSpread: boolean
            _createTotal: boolean
            0: string
            1: string
            2: string
            3: string
        ...
        decodeResolution(_payload: string | number[]): NonPayableTransactionObject<{
            _eventId: string
            _eventStatus: string
            _homeScore: string
            _awayScore: string
        ...
        events(arg0: number | string | BN, arg1: number | string | BN): NonPayableTransactionObject<string>
        ...
        isEventRegistered(_eventId: number | string | BN): NonPayableTransactionObject<boolean>

        isEventResolved(_eventId: number | string | BN): NonPayableTransactionObject<boolean>
        ...
        trustedResolveMarkets(_payload: string | number[]): NonPayableTransactionObject<void>
    }
    events: {
