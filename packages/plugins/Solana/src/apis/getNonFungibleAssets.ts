...
async function getNftList(chainId: ChainId, account: string): Promise<NonFungibleToken<ChainId, SchemaType>[]> {
    ...
    return assets as NonFungibleAsset<ChainId, SchemaType>[]
}
