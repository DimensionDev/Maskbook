import { PluginID, resolveIPFS_URL } from '@masknet/web3-shared-base'
...
export const RSS3_DEFAULT_IMAGE = resolveIPFS_URL('QmVFq9qimnudPcs6QkQv8ZVEsvwD3aqETHWtS5yXgdbYY5')!
