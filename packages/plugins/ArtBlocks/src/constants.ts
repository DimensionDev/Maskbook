...
export const artBlocksPathnameRegex = /^\/project\/(\d+)|^\/collections\/.*?\/projects\/0x.{40}\/(\d+)/u
...
export const URL_PATTERN = /https:\/\/(www.artblocks.io|artist-staging.artblocks.io)\/project\/(\d+)/u
