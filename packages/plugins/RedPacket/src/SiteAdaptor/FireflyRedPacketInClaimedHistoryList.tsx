...
export const FireflyRedPacketInClaimedHistoryList = memo(function FireflyRedPacketInClaimedHistoryList({
    history,
    handleOpenDetails,
}: Props) {
    const {
                            ...
                            <div className={classes.div}>
                                ...
                                <div className={classes.fullWidthBox}>
                                    ...
                                    <Typography variant="body1" className={cx(classes.info, classes.message)}>
                                        {t.history_duration({
                                            time: format(new Date(Number(received_time) * 1000), 'M/d/yyyy HH:mm'),
                                        })}
                                    </Typography>
                                </div>
                                <div className={classes.fullWidthBox}>
