...
export const FireflyRedPacketDetailsItem = memo(function RedPacketInHistoryList(props: Props) {
  ...
  const { rp_msg, create_time, claim_numbers, total_numbers, total_amounts, token_decimal, claim_amounts, token_symbol, token_logo, chain_id, creator } = claimInfo
        ...
        <Box className={classes.box}>
          <Box className={classes.content}>
            ...
            <section className={classes.footer}>
              ...
              <button className={classes.moreDetails} onClick={() => { }}>
                More details
              </button>
            </section>
          </Box>
