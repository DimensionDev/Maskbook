    ...
    protected override getProviders(initial?: HubOptions<ChainId>) {
        ...
        >(
            ...
            options.chainId === ChainId.Mainnet
                ? [
                      X2Y2,
                      isDeviceOnWhitelist(Flags.simplehash_ab_percentage) ? NFTScanNonFungibleTokenEVM : SimpleHashEVM,
                      isDeviceOnWhitelist(Flags.simplehash_ab_percentage) ? SimpleHashEVM : NFTScanNonFungibleTokenEVM,
                      ZerionNonFungibleToken,
                      Rarible,
                      OpenSea,
                      AlchemyEVM,
