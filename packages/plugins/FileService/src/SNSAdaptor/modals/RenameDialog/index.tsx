...
export const RenameModal = forwardRef<SingletonModalRefCreator<RenameModalOpenProps>, RenameModalProps>(
    (props, ref) => {
        ...
        if (!open) return null
        return (
            <RenameDialog open onClose={() => dispatch?.close()} {...props_} currentName={props_?.currentName ?? ''} />
        )
    },
)
