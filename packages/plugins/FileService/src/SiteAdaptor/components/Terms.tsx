            ...
            <div className={classes.content}>
                ...
                <Typography variant="body2" className={classes.introduction}>
                    <Trans>
                        ...
                        partner protocols, including Arweave. It supports various file formats such as PDF, DOC, JPG,
                        PNG, MP3, MP4, and more, with a maximum file size of 10MB per upload.
                        <br />
