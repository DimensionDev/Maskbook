...
export const NETWORK_DESCRIPTORS: ReadonlyArray<NetworkDescriptor<ChainId, NetworkType>> = [
    ...
    },
    {
        ...
        type: NetworkType.Manta,
        icon: new URL('../assets/manta.svg', import.meta.url).href,
        iconColor: 'rgb(36, 150, 238)',
        name: 'Manta',
        isMainnet: true,
        averageBlockDelay: 10,
    ...
    {
        ID: `${PLUGIN_ID}_zksync`,
        networkSupporterPluginID: PLUGIN_ID,
        chainId: ChainId.ZKSync,
        type: NetworkType.ZKSync,
        icon: new URL('../assets/zksync.svg', import.meta.url).href,
        iconColor: 'rgb(36, 150, 238)',
        name: 'ZKSync',
        isMainnet: true,
        averageBlockDelay: 10,
