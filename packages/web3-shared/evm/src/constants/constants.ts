...
export const getLensContants = transformAll(ChainId, Lens)
export const useLensConstant = transformHook(getLensContants)
export const useLensConstatns = transformAllHook(getLensContants)
