...
import { isUndefined, omitBy, toNumber } from 'lodash-es'
import * as ABICoder from 'web3-eth-abi'
import { type AbiItem, hexToBytes, keccak256, padLeft, toHex } from 'web3-utils'
...
import type { ChainId, Transaction, UserOperation, Web3 } from '../types/index.js'
import {
    getZeroAddress,
    isZeroString,
    isEmptyHex,
