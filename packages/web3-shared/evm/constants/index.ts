...
import Saving from '@masknet/web3-constants/evm/saving.json'
...
export const getSavingConstants = transform(Saving)
export const useSavingConstants = hookTransform(getSavingConstants)
