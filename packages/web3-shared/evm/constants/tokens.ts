...
export const SOLAR = createERC20Tokens('SOLAR_ADDRESS', 'Pangolin', 'PNG', 18)
export const mCUSD = createERC20Tokens('mCUSD_ADDRESS', 'Moola interest bearing', 'mcUSD', 18)
export const mCELO = createERC20Tokens('mCELO_ADDRESS', 'Moola interest bearing', 'mCELO', 18)
export const mcEUR = createERC20Tokens('mcEUR_ADDRESS', 'Moola interest bearing', 'mcCEUR', 18)
