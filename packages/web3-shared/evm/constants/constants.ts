...
import Convex from '@masknet/web3-constants/evm/convex.json'
...
export const getConvexConstants = transform(Convex)
export const useConvexConstants = hookTransform(getConvexConstants)
