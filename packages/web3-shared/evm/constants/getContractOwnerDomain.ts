...
const domainAddressMap: Record<string, string[]> = {
    ...
    'diffusion.fi': collect(Trader, ['DIFFUSION_ROUTER_ADDRESS', 'DIFFUSION_FACTORY_ADDRESS']),
    'cronusfinance.xyz': collect(Trader, ['CRONUS_ROUTER_ADDRESS', 'CRONUS_FACTORY_ADDRESS']),
    'app.evmoswap.org': collect(Trader, ['EVMOSWAP_ROUTER_ADDRESS', 'EVMOSWAP_FACTORY_ADDRESS']),
