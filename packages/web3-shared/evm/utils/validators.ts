...
export const isBlockNumber = (obj: any): boolean => {
    const blockParams = [DefaultBlockParams.earliest, DefaultBlockParams.pending, DefaultBlockParams.latest]
