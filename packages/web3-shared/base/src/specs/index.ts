...
export interface OthersState<ChainId, SchemaType, ProviderType, NetworkType, Transation> {
    // #region resolvers
    ...
    getTransactionSignature(chainId?: ChainId, transaction?: Partial<Transation>): string | undefined
    // #endregion
}
