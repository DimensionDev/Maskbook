...
describe('EUR Currency format util test', () => {
    test.each([
        { give: 0, expected: '\u{20AC}0.00' },
        { give: 0.1, expected: '\u{20AC}0.1' },
        { give: 0.2, expected: '\u{20AC}0.2' },
        { give: 0.12, expected: '\u{20AC}0.12' },
        { give: 0.1234111, expected: '\u{20AC}0.123411' },
        { give: 0.1234115, expected: '\u{20AC}0.123412' },
        { give: 1, expected: '\u{20AC}1.00' },
        { give: 1.1, expected: '\u{20AC}1.10' },
        { give: 1.55, expected: '\u{20AC}1.55' },
        { give: 2, expected: '\u{20AC}2.00' },
        { give: 2.11, expected: '\u{20AC}2.11' },
        { give: 2.111, expected: '\u{20AC}2.11' },
        { give: 2.115, expected: '\u{20AC}2.12' },
        { give: 2_000_000_000_000, expected: '\u{20AC}2,000,000,000,000.00' },
        { give: 0.1234, expected: '\u{20AC}0.1234' },
        { give: 0.1234111, expected: '\u{20AC}0.123411' },
        { give: 0.1234115, expected: '\u{20AC}0.123412' },
        { give: 0.000001, expected: '\u{20AC}0.000001' },
        { give: 0.00000101, expected: '\u{20AC}0.000001' },
        { give: 0.000002, expected: '\u{20AC}0.000002' },
        { give: 0.000000135554455, expected: '\u{20AC}0.0000001356' },
        { give: 1e-15, expected: '< \u{20AC}0.000001' },
...
describe('Digital currency format util test', () => {
    test.each([
        { give: 0, currency: 'ETH', expected: '0.00 \u{39E}' },
        { give: 1.55, currency: 'ETH', expected: '1.55 \u{39E}' },
        { give: 1.55, currency: 'BTC', expected: '1.55 \u{20BF}' },
