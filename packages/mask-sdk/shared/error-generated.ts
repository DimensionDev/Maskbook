...
// prettier-ignore
const codeMap = {
    "Invalid input": -32_000,
    "Resource not found": -32_001,
    "Resource unavailable": -32_002,
    "Transaction rejected": -32_003,
    "Method not supported": -32_004,
    "Limit exceeded": -32_005,
    "JSON-RPC version not supported": -32_006,
    "Invalid request": -32_600,
    "The method \"eth_subscribe\" is only available on the mainnet.": -32_601,
    "Invalid address": -32_602,
    "Invalid params": -32_602,
    "A permission request must contain at least 1 permission.": -32_602,
    "A symbol is required, but was not found in either the request or contract": -32_602,
    "Decimals are required, but were not found in either the request or contract": -32_602,
    "The token address seems invalid": -32_602,
    "Unable to verify ownership. Possibly because the standard is not supported or the user's currently selected network does not match the chain of the asset in question.": -32_602,
...
export const err = {
    invalid_input(options: MaskEthereumProviderRpcErrorOptions = {}) {
        return new MaskEthereumProviderRpcError(-32_000, "Invalid input", options)
    },
    resource_not_found(options: MaskEthereumProviderRpcErrorOptions = {}) {
        return new MaskEthereumProviderRpcError(-32_001, "Resource not found", options)
    },
    resource_unavailable(options: MaskEthereumProviderRpcErrorOptions = {}) {
        return new MaskEthereumProviderRpcError(-32_002, "Resource unavailable", options)
    },
    transaction_rejected(options: MaskEthereumProviderRpcErrorOptions = {}) {
        return new MaskEthereumProviderRpcError(-32_003, "Transaction rejected", options)
    },
    method_not_supported(options: MaskEthereumProviderRpcErrorOptions = {}) {
        return new MaskEthereumProviderRpcError(-32_004, "Method not supported", options)
    },
    limit_exceeded(options: MaskEthereumProviderRpcErrorOptions = {}) {
        return new MaskEthereumProviderRpcError(-32_005, "Limit exceeded", options)
    },
    json_rpc_version_not_supported(options: MaskEthereumProviderRpcErrorOptions = {}) {
        return new MaskEthereumProviderRpcError(-32_006, "JSON-RPC version not supported", options)
    },
    ...
    the_method_eth_subscribe_is_only_available_on_the_mainnet(options: MaskEthereumProviderRpcErrorOptions = {}) {
        return new MaskEthereumProviderRpcError(-32_601, "The method \"eth_subscribe\" is only available on the mainnet.", options)
    },
    invalid_address(options: MaskEthereumProviderRpcErrorOptions = {}) {
        return new MaskEthereumProviderRpcError(-32_602, "Invalid address", options)
    },
    invalid_params(options: MaskEthereumProviderRpcErrorOptions = {}) {
        return new MaskEthereumProviderRpcError(-32_602, "Invalid params", options)
    },
    ...
    wallet_watchAsset: {
        a_symbol_is_required_but_was_not_found_in_either_the_request_or_contract(options: MaskEthereumProviderRpcErrorOptions = {}) {
            return new MaskEthereumProviderRpcError(-32_602, "A symbol is required, but was not found in either the request or contract", options)
        },
        ...
        the_token_address_seems_invalid(options: MaskEthereumProviderRpcErrorOptions = {}) {
            return new MaskEthereumProviderRpcError(-32_602, "The token address seems invalid", options)
        },
        unable_to_verify_ownership_possibly_because_the_standard_is_not_supported_or_the_users_currently_selected_network_does_not_match_the_chain_of_the_asset_in_question(options: MaskEthereumProviderRpcErrorOptions = {}) {
            return new MaskEthereumProviderRpcError(-32_602, "Unable to verify ownership. Possibly because the standard is not supported or the user's currently selected network does not match the chain of the asset in question.", options)
        },
    },
    internal_error(options: MaskEthereumProviderRpcErrorOptions = {}) {
        return new MaskEthereumProviderRpcError(-32_603, "Internal error", options)
    },
    parse_error(options: MaskEthereumProviderRpcErrorOptions = {}) {
        return new MaskEthereumProviderRpcError(-32_700, "Parse error", options)
    },
