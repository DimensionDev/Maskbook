...
function ser<T, Q>(clz: { new (...args: any): T; name: string }, encode: (a: T) => Q, decode: (a: Q) => T) {
    return [
        (v: T) => {
...
const [ArrayBufferEncode, ArrayBufferDecode] = ser(
    ArrayBuffer,
    (e) => [...new Uint8Array(e)],
    (e) => new Uint8Array(e).buffer,
)
const [U8ArrayEncode, U8ArrayDecode] = ser(
    Uint8Array,
    (e) => [...e],
    (e) => new Uint8Array(e),
)
...
export const serializer = JSONSerialization(
    [
        (key, value) => {
            ...
            if (value instanceof Uint8Array) return ArrayBuffer
            return value
        },
        (key, value) => {
