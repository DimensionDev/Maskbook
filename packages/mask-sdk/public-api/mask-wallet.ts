...
export declare namespace Ethereum.RPC {
    ...
    interface ImplementedMethods {
        ...
        eth_gasPrice: () => string
        eth_getBalance: (address: string, block?: string | null) => string
        eth_getBlockByHash: (hash: string, hydrated_transactions?: boolean | null) => Block | null
        eth_getBlockByNumber: (block: string, hydrated_transactions?: boolean | null) => Block | null
        ...
        eth_getCode: (address: string, block?: string | null) => string
        ...
        eth_getTransactionCount: (address: string, block?: string | null) => string
