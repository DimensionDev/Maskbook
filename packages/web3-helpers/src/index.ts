...
export declare namespace Web3Helper {
    ...
    >
    export type ChainIdScope<S extends 'all' | void = void, T extends NetworkPluginID = NetworkPluginID> =
        S extends 'all' ? ChainIdAll : Definition[T]['ChainId']

    export type AddressTypeScope<S extends 'all' | void = void, T extends NetworkPluginID = NetworkPluginID> =
        S extends 'all' ? AddressTypeAll : Definition[T]['AddressType']

    export type GasOptionScope<S extends 'all' | void = void, T extends NetworkPluginID = NetworkPluginID> =
        S extends 'all' ? GasOptionAll : Definition[T]['GasOption']

    export type NetworkTypeScope<S extends 'all' | void = void, T extends NetworkPluginID = NetworkPluginID> =
        S extends 'all' ? NetworkTypeAll : Definition[T]['NetworkType']

    export type ProviderTypeScope<S extends 'all' | void = void, T extends NetworkPluginID = NetworkPluginID> =
        S extends 'all' ? ProviderTypeAll : Definition[T]['ProviderType']

    export type SchemaTypeScope<S extends 'all' | void = void, T extends NetworkPluginID = NetworkPluginID> =
        S extends 'all' ? SchemaTypeAll : Definition[T]['SchemaType']

    export type TransactionScope<S extends 'all' | void = void, T extends NetworkPluginID = NetworkPluginID> =
    ...
    export type ChainDescriptorScope<S extends 'all' | void = void, T extends NetworkPluginID = NetworkPluginID> =
        S extends 'all' ? ChainDescriptorAll
        :   ChainDescriptor<Definition[T]['ChainId'], Definition[T]['SchemaType'], Definition[T]['NetworkType']>

    export type NetworkDescriptorScope<S extends 'all' | void = void, T extends NetworkPluginID = NetworkPluginID> =
        S extends 'all' ? NetworkDescriptorAll
        :   NetworkDescriptor<Definition[T]['ChainId'], Definition[T]['NetworkType']>

    export type ProviderDescriptorScope<S extends 'all' | void = void, T extends NetworkPluginID = NetworkPluginID> =
        S extends 'all' ? ProviderDescriptorAll
        :   ProviderDescriptor<Definition[T]['ChainId'], Definition[T]['ProviderType']>

    export type Web3ProviderScope<S extends 'all' | void = void, T extends NetworkPluginID = NetworkPluginID> =
        S extends 'all' ? Web3ProviderAll : Definition[T]['Web3Provider']

    export type Web3StateScope<S extends 'all' | void = void, T extends NetworkPluginID = NetworkPluginID> =
        S extends 'all' ? Web3StateAll
        :   Web3StateShared<
                Definition[T]['ChainId'],
                Definition[T]['SchemaType'],
                Definition[T]['ProviderType'],
    ...
    export type Web3Scope<S extends 'all' | void = void, T extends NetworkPluginID = NetworkPluginID> =
        S extends 'all' ? Web3All : Definition[T]['Web3']
}
