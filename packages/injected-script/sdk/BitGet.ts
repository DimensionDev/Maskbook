...
export class BitGetProvider extends InjectedWalletBridge {
    constructor() {
        super('bitkeep.ethereum')
    }

    override async untilAvailable(): Promise<void> {
        await super.untilAvailable(async () => !!(await super.getProperty<boolean>('isBitKeep')))
    }
