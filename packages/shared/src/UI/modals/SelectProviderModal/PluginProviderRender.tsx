...
import { getAllPluginsWeb3State, getOthersAPI } from '@masknet/web3-providers'
...
export const PluginProviderRender = memo(function PluginProviderRender({
    ...
    const [, handleClick] = useAsyncFn(
        async (provider: Web3Helper.ProviderDescriptorAll, expectedChainId?: Web3Helper.ChainIdAll) => {
            ...
            const downloadLink = getOthersAPI(provider.providerAdaptorPluginID)?.providerResolver.providerDownloadLink(
                provider.type,
            )
