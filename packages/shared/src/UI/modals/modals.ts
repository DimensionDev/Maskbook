...
import type { SelectGasSettingsModalOpenProps } from './SelectAdvancedSettingsDialog/index.js'
...
export const SelectGasSettingsModal = new SingletonModal<SelectGasSettingsModalOpenProps>()
