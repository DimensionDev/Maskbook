...
import type { SelectFungibleTokenModalOpenProps } from './SelectFungibleTokenModal/index.js'
...
export const SelectFungibleTokenModal = new SingletonModal<SelectFungibleTokenModalOpenProps>()
