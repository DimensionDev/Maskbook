...
declare -a selfHostedContracts=("happy-red-packet" "bulk-checkout" "splitter")

for i in "${selfHostedContracts[@]}"
do
...
# external contracts
declare -a externalContracts=("balance-checker")

for i in "${externalContracts[@]}"
do
    for f in ./contracts/$i/*.abi
    do 
        # generate typings
