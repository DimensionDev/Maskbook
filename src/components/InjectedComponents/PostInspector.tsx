...
export function PostInspector(props: PostInspectorProps) {
    ...
    const postAttachments = usePostInfoDetails('postAttachments')
    ...
    const debugInfo = isDebugging ? (
        <DebugList
            items={[
                ...
                ['Post Attachment Links', JSON.stringify(postAttachments)],
            ]}
        />
    ) : null

    if (encryptedPost.ok || postAttachments.length) {
