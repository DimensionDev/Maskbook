        ...
        <section className={classes.wrapper}>
            ...
            <main className={classes.main}>
                <Typography component="p" variant="inherit">
                    Maskbook allows you to publish encrypted posts on social networks, so that you may mitigate the big
                    data surveillance from the big corporations. Only you and your friends (who are also using Maskbook)
                    can decrypt your encrypted posts.
                </Typography>
...
export function useDashboardAboutDialog() {
    return useDialog(<DashboardAboutDialog />, undefined, 'white')
}
