...
export function RedPacketSimplified(props: { onClick?(): void }) {
    ...
    return (
        <Card elevation={0} className={classes.box} component="article" onClick={onClick}>
            <div className={classes.content}>
                ...
                <Typography variant="body1">Ready to open</Typography>
            </div>
            <div className={classNames(classes.packet, classes.position2)}></div>
        </Card>
    )
}
...
export function RedPacket(props: { onClick?(): void }) {
    ...
    const { onClick } = props
    return (
        <Card elevation={0} className={classNames(classes.box, classes.height2)} component="article" onClick={onClick}>
