...
export default defineConfig({
    test: {
        ...
        alias: {
            ...
            '@masknet/web3-shared-bitcoin': createURL('./packages/web3-shared/bitcoin/src/index.ts'),
            ...
            '@masknet/plugin-infra/dom': createURL('./packages/plugin-infra/src/dom/index.ts'),
            '@masknet/plugin-infra': createURL('./packages/plugin-infra/src/entry.ts'),
            '@masknet/theme': createURL('./packages/theme/src/index.ts'),
        },
