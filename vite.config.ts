...
export default defineConfig({
    test: {
        ...
        alias: {
            ...
            '@masknet/web3-telemetry/types': import.meta.resolve('./packages/web3-telemetry/src/entry-types.ts'),
            '@masknet/web3-telemetry/helpers': import.meta.resolve('./packages/web3-telemetry/src/entry-helpers.ts'),
            '@masknet/web3-telemetry': import.meta.resolve('./packages/web3-telemetry/src/entry.ts'),
